module.exports = {
  ...
  testPathIgnorePatterns: [
    ...
    'src/store/reducers/feelService.test.js',
    'src/components/screens/register/register.test.js',
  ...
  coveragePathIgnorePatterns: [
    ...
    'src/actions/feelService.js',
    'src/actions/transactions.js',
    'src/actions/blocks.js',
    'src/actions/network/gcc.js',
    ...
    'src/store/reducers/feelService.js',
    ...
    'src/utils/api/gcc/feelService.js',
    'src/utils/api/btc/',
    'src/utils/api/delegates.js',
    'src/utils/api/gcc/adapters.js',
    'src/utils/api/gcc/account.js',
