...
## Finding first issue
Go to [issues tab](https://github.com/feelfoundation/feel-desktop/issues) and look for 

*✏️ `good first issue`* - it is a label for tasks that are perfect for people who want to start with Feel.

## Reporting issues

 1. Check if problem already exist in [issues tab](https://github.com/feelfoundation/feel-desktop/issues)
 2. If not, create a new [issue](https://github.com/feelfoundation/feel-desktop/issues/new/choose)
