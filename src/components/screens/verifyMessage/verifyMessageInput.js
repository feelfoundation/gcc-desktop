...
export default class VerifyMessageInput extends React.Component {
  constructor(props) {
    ...
    this.textarea = {
      name: 'signedMessage',
      placeholder: t('Enter the entire signature generated by Feel'),
  ...
  getInputs() {
    ...
    const separators = ['MESSAGE', 'PUBLIC KEY', 'SIGNATURE', 'END FEEL SIGNED MESSAGE'].join('|');
        ...
        <BoxContent className={styles.content}>
          <BoxInfoText>
            ...
            <Tooltip position="bottom">
              <p>{t('If you would like to ensure the ownership of another account, you can send a message via Feel and request the recipient to sign it.')}</p>
            </Tooltip>
          </BoxInfoText>
