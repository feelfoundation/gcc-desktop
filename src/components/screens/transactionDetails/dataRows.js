  ...
  <BoxRow>
        ...
        <div className={styles.value}>
          ...
          <DiscreetMode addresses={addresses} shouldEvaluateForOtherAccounts>
            <span className="tx-amount">
              <FeelAmount val={transaction.amount} />
              {' '}
              {activeToken}
            </span>
          </DiscreetMode>
    ...
    <div className={styles.value}>
      ...
      <span className="tx-fee">
        <FeelAmount val={transaction.fee} />
        {' '}
        {activeToken}
      </span>
    </div>
    ...
    <div className={styles.value}>
      ...
      <span className={`${styles.date} tx-date`}>
        <DateTimeFromTimestamp
          fulltime
          className="date"
          time={transaction.timestamp * 1000 + 28800000}
          token={activeToken}
          showSeconds
        />
      </span>
...
export const Message = ({
  ...
  if (transaction.type !== transactionTypes().transfer.code || activeToken !== 'GCC') return null;
  return (
