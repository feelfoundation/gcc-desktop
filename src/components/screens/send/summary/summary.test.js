...
describe('Summary', () => {
  ...
  it('should render properly', () => {
    ...
    expect(wrapper.find('button.confirm-button')).toHaveText('Send 1.123 GCC');
    expect(wrapper.find('.amount-summary')).toIncludeText('1.123 GCC');
  });
  ...
  it('should show props.fields.fee.value and use it in transactionCreated if props.token is not GCC', () => {
    const txFee = 12451;
