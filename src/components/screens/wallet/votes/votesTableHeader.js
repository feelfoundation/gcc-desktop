...
export default t => ([
  ...
  },
  {
    ...
    tooltip: {
      title: t('Forged'),
      message: t('Sum of all GCC awarded to a delegate for each block successfully generated on the blockchain.'),
      position: 'bottom',
    },
  },
  {
  ...
  },
  {
    ...
    tooltip: {
      title: t('Productivity'),
      message: t('Sum of GCC in all accounts who have voted for this delegate.'),
      position: 'left',
    },
  },
]);
