...
import { transactions } from '@feelhq/feel-client';
import Spinner from '../../toolbox/spinner';
import DialogLink from '../../toolbox/dialog/link';
import styles from './settings.css';
import Icon from '../../toolbox/icon';

const fee = transactions.utils.convertFellowsToGCC('5');
            ...
            {account.balance < 5
              ? (
                <p className={styles.highlight}>
                  {t('You don’t have enough balance to enable it. {{fee}} GCC is required.', { fee })}
                </p>
              )
              : (
                <React.Fragment>
