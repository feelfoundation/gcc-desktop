        ...
        <Box className={styles.wrapper}>
          ...
          <BoxContent className={styles.content}>
            ...
            <section>
              ...
              {!account.afterLogout && account.token === tokenMap.GCC.key
                ? (
            ...
            <section style={{ display: 'none' }}>
              ...
              {
                !isHardwareWalletAccount && !isEmpty(account) && false
                  ? (
            ...
            <section>
              ...
              <label className={`${styles.fieldGroup} ${styles.checkboxField}`}>
                ...
                <div>
                  ...
                  <p>{t('Help improve Feel by allowing Feel to gather anonymous usage data used for analytical purposes.')}</p>
