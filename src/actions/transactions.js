...
import { txAdapter } from '../utils/api/gcc/adapters';
 ...
 * @param {Number} data.amount - In raw format (satoshis, fellows)
 ...
 * @param {Number} data.reference - Data field for GCC transactions
 * @param {String} data.secondPassphrase - Second passphrase for GCC transactions
 */
 ...
 * @param {Number} transaction.amount - In raw format (satoshis, fellows)
 ...
 * @param {Number} transaction.reference - Data field for GCC transactions
 * @param {String} transaction.secondPassphrase - Second passphrase for GCC transactions
 */
// TODO remove this function once create and broadcast HOC be implemented
