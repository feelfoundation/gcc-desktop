...
import { setSecondPassphrase } from '../utils/api/gcc/account';
...
/* istanbul ignore next */
  (dispatch, getState) => {
    ...
    const { networkIdentifier } = network.networks.GCC;
    const feelAPIClient = getAPIClient(active, network);
    setSecondPassphrase(
      feelAPIClient,
      secondPassphrase,
      account.publicKey,
 ...
 * @param {String} data.publicKey - Feel publicKey used for hardware wallet login
