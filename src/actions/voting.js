 ...
 * https://github.com/feelfoundation/feel-desktop/blob/d284b32f747e6b5c9189a3aeeff975b13a7a466b/src/components/delegatesListView/index.js#L21-L23
 */
...
export const votePlaced = ({
  ...
  async (dispatch, getState) => { // eslint-disable-line max-statements
    ...
    const { networkIdentifier } = state.network.networks.GCC;
    const feelAPIClient = getAPIClient(tokenMap.GCC.key, state.network);
