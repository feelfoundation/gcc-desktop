...
const addAboutMenuForNonMac = ({ template, electron }) => {
  const copyright = `Copyright © 2016 - ${new Date().getFullYear()} Feel Foundation`;
  template[template.length - 1].submenu.push({
    ...
    click(item, focusedWindow) {
      if (focusedWindow) {
        const options = {
          buttons: ['OK'],
          icon: `${__dirname}/assets/images/FEEL.png`,
      ...
      },
      {
        ...
        submenu: [
          ...
          },
          {
            ...
            click: menu.onClickLink.bind(null, electron, 'https://github.com/feelfoundation/feel-desktop/releases'),
          },
        ],
      },
    ]),
